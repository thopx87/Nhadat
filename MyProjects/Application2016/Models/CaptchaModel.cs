...
namespace Application2016.Models
{
    public class CaptchaModel
    {
        ...
        public CaptchaModel(int width, int height, System.Drawing.FontFamily fontFamily)
        {
            this.width = width;
            this.height = height;
            this.fontFamily = fontFamily;
        }
        public CaptchaModel(string s, int width, int height, System.Drawing.FontFamily fontFamily)
        {
            this.text = s;
            this.width = width;
            this.height = height;
