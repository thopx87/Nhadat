...
namespace Application2016.Helpers
{
    public static class AdminConfigs
    {
        ...
        public const string FRIENDLY_LINK_ARTICLE = "bai-viet";
        ...
        public const string COOKIES_AGENCY = "Agency";
        ...
        public const string BUTTON_POST_NEW = "Đăng tin";
        ...
        public const string CONFIRM_DELETE_PRODUCT = "Bạn có chắc chắn muốn xóa sản phẩm này không?";
        public const string CONFIRM_PRODUCT_SOLD = "Bạn có chắc chắn sản phẩm này đã được bán không?";
        public const string CONFIRM_DELETE_USERS = "Bạn có chắc chắn muốn xóa những tài khoản này không?";
        ...
        public const string MESSAGE_DELETE_ERROR = "Xóa không thành công!";
        public const string MESSAGE_NOT_DATA = "Chưa có dữ liệu";
        public const string MESSAGE_NOT_CHOICE = "Bạn chưa chọn đối tượng nào!";
        ...
        public const string MESSAGE_REGISTER_MEMBER_OK = "Bạn đã đăng ký thành công! Xin hãy kiểm tra Email để kích hoạt tài khoản.";
        public const string MESSAGE_REGISTER_MEMBER_ERROR = "Đã có lỗi trong quá trình đăng ký. Xin vui lòng kiểm tra lại thông tin."; 
        public const string MESSAGE_REGISTER_AGENCY_OK = "Xin chúc mừng! Bạn đã đăng ký làm môi giới thành công.";
        ...
        // Thông báo khi có thông tin cập nhật sản phẩm
        public const string MESSAGE_PRODUCT_01 = "người mua [user] đã đặt mua sản phẩm [product] với giá {0}";
        public const string MESSAGE_PRODUCT_02 = "người mua [user] đã thay đổi giá mua sản phẩm [product] từ {0} thành {1}";
        public const string MESSAGE_PRODUCT_03 = "người bán [user] đã thay đổi giá bán sản phẩm [product] thành {0}";
        public const string MESSAGE_PRODUCT_04 = "người bán [user] muốn bán sản phẩm [product] cho bạn. Hãy gọi điện tới số [phone] để có thể mua sản phẩm này";
        ...
        public const string ERROR_CAPTCHA = "Captcha không đúng. Xin vui lòng nhập lại";
